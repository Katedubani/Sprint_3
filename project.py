...
class OnlineSalesRegisterCollector:
    ...
    def get_date_and_time():
        ...
        date.append(['часы', (lambda x: x.hour)(now)])
        date.append(['минуты', (lambda x: x.minute)(now)])
        date.append(['день', (lambda x: x.day)(now)])
        date.append(['месяц', (lambda x: x.month)(now)])
        date.append(['год', (lambda x: x.year)(now)])
        for l in date:
